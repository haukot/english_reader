...
const defaultBook = {
  ...
  pages: [[0, 812]],
  name: "Default book",
  text: "Default Book. \n <span class=\"sentence\">The Eye of the <span t=\"x\">World</span> is the <span t=\"j\">best</span> of its <span t=\"n\">genre</span>.\n\n</span><span class=\"sentence\"></span><span class=\"sentence\">The Ottawa Citizen\n\n\n\n<span t=\"j\">splendid</span> <span t=\"n\">tale</span> of <span t=\"j\">heroic</span> <span t=\"n\">fantasy</span>, <span t=\"j\">vast</span> in <span t=\"n\">scope</span>, <span t=\"j\">colorful</span> in <span t=\"n\">detail</span>, and <span t=\"j\">convincing</span> in its <span t=\"n\">presentation</span> of <span t=\"j\">human</span> <span t=\"n\">character</span> and <span t=\"n\">personality</span>.I'm <span t=\"v\">living</span>. <span t=\"v\">gilded</span>. <span t=\"j\">wryly</span>. <span t=\"n\">stung</span> <span t=\"n\">littermates</span>.\n\nL. Sprague De Camp\n</span>",
  currentPage: 1
}
